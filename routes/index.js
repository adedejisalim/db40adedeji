...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Food Rating App', user: req.user });
});

router.get('/register', function(req, res) { 
  res.render('register', { title: 'Food Rating App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
  res.render('login', { title: 'Food Rating App Login', user : req.user }); 
}); 
